    ...
    <div class="mt-8 space-y-4">
        ...
        @empty
            <div class="rounded-2xl border border-dashed border-[#3FA7D6]/50 bg-[#F8FAFC] p-9 text-center">
                ...
                <a href="{{ route('articles.index') }}" class="inline-flex mt-4 rounded-full border border-[#0F4C6C]/20 bg-white px-4 py-2 text-sm font-medium text-[#0F4C6C] hover:border-[#3FA7D6]/70 hover:text-[#3FA7D6] transition-colors">
                    Lihat Semua Artikel
                </a>
            </div>
        @endforelse
